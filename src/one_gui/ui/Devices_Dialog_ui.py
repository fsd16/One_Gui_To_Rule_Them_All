...
class Ui_DevicesDialog(object):
    def setupUi(self, DevicesDialog):
        ...
        self.sas_entry_address = QComboBox(DevicesDialog)
        self.sas_entry_address.setObjectName(u"sas_entry_address")
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sas_entry_address.sizePolicy().hasHeightForWidth())
        self.sas_entry_address.setSizePolicy(sizePolicy)
        self.sas_entry_address.setEditable(True)
        ...
        self.rlc_entry_address_p = QComboBox(DevicesDialog)
        self.rlc_entry_address_p.setObjectName(u"rlc_entry_address_p")
        self.rlc_entry_address_p.setEditable(True)
        ...
        self.gridLayout.addWidget(self.sas_menu_config, 6, 2, 1, 1)
        ...
        self.chamber_entry_address = QComboBox(DevicesDialog)
        self.chamber_entry_address.setObjectName(u"chamber_entry_address")
        sizePolicy.setHeightForWidth(self.chamber_entry_address.sizePolicy().hasHeightForWidth())
        self.chamber_entry_address.setSizePolicy(sizePolicy)
        self.chamber_entry_address.setEditable(True)

        self.gridLayout.addWidget(self.chamber_entry_address, 8, 2, 1, 1)
        ...
        self.rlc_entry_address_r = QComboBox(DevicesDialog)
        self.rlc_entry_address_r.setObjectName(u"rlc_entry_address_r")
        sizePolicy.setHeightForWidth(self.rlc_entry_address_r.sizePolicy().hasHeightForWidth())
        self.rlc_entry_address_r.setSizePolicy(sizePolicy)
        self.rlc_entry_address_r.setEditable(True)

        self.gridLayout.addWidget(self.rlc_entry_address_r, 2, 2, 1, 1)

        self.scope_entry_address = QComboBox(DevicesDialog)
        self.scope_entry_address.setObjectName(u"scope_entry_address")
        sizePolicy.setHeightForWidth(self.scope_entry_address.sizePolicy().hasHeightForWidth())
        self.scope_entry_address.setSizePolicy(sizePolicy)
        self.scope_entry_address.setEditable(True)

        self.gridLayout.addWidget(self.scope_entry_address, 1, 2, 1, 1)

        self.ac_entry_address = QComboBox(DevicesDialog)
        self.ac_entry_address.setObjectName(u"ac_entry_address")
        sizePolicy.setHeightForWidth(self.ac_entry_address.sizePolicy().hasHeightForWidth())
        self.ac_entry_address.setSizePolicy(sizePolicy)
        self.ac_entry_address.setEditable(True)
