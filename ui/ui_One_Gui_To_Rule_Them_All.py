...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_8.addWidget(self.sas_butt_off, 1, 3, 1, 1, Qt.AlignHCenter|Qt.AlignBottom)
        ...
        self.gridLayout_8.addWidget(self.sas_butt_close, 1, 4, 1, 1, Qt.AlignHCenter|Qt.AlignBottom)
        ...
        self.gridLayout_8.addWidget(self.sas_butt_on, 1, 2, 1, 1, Qt.AlignHCenter|Qt.AlignBottom)
        ...
        self.gridLayout_8.addWidget(self.sas_butt_apply, 1, 0, 1, 1, Qt.AlignHCenter|Qt.AlignBottom)
        ...
        self.gridLayout.addWidget(self.label_3, 3, 4, 1, 2, Qt.AlignHCenter|Qt.AlignBottom)

        self.ac_check_abnormal = QCheckBox(self.ac_tab)
        self.ac_check_abnormal.setObjectName(u"ac_check_abnormal")

        self.gridLayout.addWidget(self.ac_check_abnormal, 2, 3, 1, 3, Qt.AlignHCenter|Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.ac_butt_close, 6, 5, 1, 1, Qt.AlignHCenter|Qt.AlignBottom)
        ...
        self.gridLayout.addWidget(self.ac_butt_off, 6, 3, 1, 2, Qt.AlignHCenter|Qt.AlignBottom)
        ...
        self.gridLayout.addWidget(self.ac_entry_step_size, 4, 4, 1, 2, Qt.AlignHCenter|Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.ac_entry_ac_volts, 4, 2, 1, 2, Qt.AlignHCenter|Qt.AlignTop)

        self.ac_radio_single = QRadioButton(self.ac_tab)
        self.ac_radio_single.setObjectName(u"ac_radio_single")

        self.gridLayout.addWidget(self.ac_radio_single, 1, 0, 1, 3, Qt.AlignHCenter|Qt.AlignVCenter)
        ...
        self.gridLayout.addWidget(self.ac_entry_freq, 4, 0, 1, 2, Qt.AlignHCenter|Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.ac_butt_apply, 6, 0, 1, 1, Qt.AlignHCenter|Qt.AlignBottom)
        ...
        self.gridLayout.addWidget(self.label, 3, 0, 1, 2, Qt.AlignHCenter|Qt.AlignBottom)

        self.ac_menu_abnormal = QComboBox(self.ac_tab)
        self.ac_menu_abnormal.setObjectName(u"ac_menu_abnormal")

        self.gridLayout.addWidget(self.ac_menu_abnormal, 1, 3, 1, 3, Qt.AlignHCenter|Qt.AlignVCenter)
        ...
        self.gridLayout.addWidget(self.label_2, 3, 2, 1, 2, Qt.AlignHCenter|Qt.AlignBottom)

        self.ac_radio_split = QRadioButton(self.ac_tab)
        self.ac_radio_split.setObjectName(u"ac_radio_split")

        self.gridLayout.addWidget(self.ac_radio_split, 0, 0, 1, 3, Qt.AlignHCenter|Qt.AlignBottom)

        self.ac_menu_phase = QComboBox(self.ac_tab)
        self.ac_menu_phase.setObjectName(u"ac_menu_phase")

        self.gridLayout.addWidget(self.ac_menu_phase, 0, 3, 1, 3, Qt.AlignHCenter|Qt.AlignVCenter)

        self.ac_radio_three = QRadioButton(self.ac_tab)
        self.ac_radio_three.setObjectName(u"ac_radio_three")

        self.gridLayout.addWidget(self.ac_radio_three, 2, 0, 1, 3, Qt.AlignHCenter|Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.ac_butt_on, 6, 1, 1, 2, Qt.AlignHCenter)
        ...
        self.gridLayout_4.addWidget(self.rlc_butt_close, 2, 5, 1, 1, Qt.AlignHCenter)
        ...
        self.gridLayout_4.addWidget(self.rlc_butt_on, 2, 0, 1, 1, Qt.AlignHCenter)
